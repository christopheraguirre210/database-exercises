...
INSERT INTO albums(artist, name, release_date, sales, genre)
VALUES('AC/DC', 'Back in Black', 1980, 26.4, 'Hard rock');
INSERT INTO albums(artist, name, release_date, sales, genre)
VALUES ('Meat Loaf', 'Bat Out of Hell', 1977, 21.7, 'Hard rock, glam rock, heavy metal');
INSERT INTO albums(artist, name, release_date, sales, genre)
...
INSERT INTO albums(artist, name, release_date, sales, genre)
VALUES ('Various Artists', 'Grease: The Original Soundtrack', 1978, 14.4, 'Rock and roll');
INSERT INTO albums(artist, name, release_date, sales, genre)
VALUES ('Led Zeppelin', 'Led Zeppelin IV', 1971, 29.0, 'Hard rock, heavy metal, folk rock');
INSERT INTO albums(artist, name, release_date, sales, genre)
VALUES ('Michael Jackson', 'Bad', 1987, 22.2, 'Pop, dance, funk, rock');
INSERT INTO albums(artist, name, release_date, sales, genre)
...
INSERT INTO albums(artist, name, release_date, sales, genre)
VALUES ('Michael Jackson', 'Dangerous', 1991, 17.9, 'Pop, rock, R&B');
INSERT INTO albums(artist, name, release_date, sales, genre)
